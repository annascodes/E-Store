...
const DashOrders = () => {
    ...
    const processing ={ backgroundColor: "rgb(205, 253, 255)", color:'gray'}
    ...
    <div  className="px-5">
      ...
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {allOrders.allorders &&
              allOrders.allorders.map((o, o_indx) => {
                return (
                  <tr
                    key={o_indx}
                  ...
                  >
                    ...
                    <td class="text-gray-900 px-6 py-4">
                      <Link to={`/myorders/${o.user_name}`} className="underline underline-offset-4">{o.user_name}</Link>
                    </td>
                    <td class="text-gray-900 px-6 py-4">
